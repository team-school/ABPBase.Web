...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        <div class="sidebar-menu-con" :style="{width: shrink?'40px':'180px', overflow: shrink ? 'visible' : 'auto'}">
            <shrinkable-menu 
                :shrink="shrink"
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'40px':'180px'}">
            <div class="main-header">
                <div class="navicon-con">
                    <Button :style="{transform: 'rotateZ(' + (this.shrink ? '-90' : '0') + 'deg)'}" id="naCli"  type="text" @click="toggleClick">
        ...
        <div class="single-page-con" :style="{left: shrink?'40px':'180px'}">
